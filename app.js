...
const emailRepBtn = document.getElementById("email-rep-btn");
...
[Your Address]`;
    ...
    // Update mailto URL link
    const subject = encodeURIComponent(`Zoning Reform Advocacy: Let's Upzone ${cityName}!`);
    const body = encodeURIComponent(letterBody);
    emailRepBtn.href = `mailto:?subject=${subject}&body=${body}`;
}
